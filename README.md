...
| [`docs/PHASE-5.md`](docs/PHASE-5.md) | **Phase 5 阶段计划（🟡 进行中）** —— 师傅 H5：目标与范围、复用件盘点、交付物清单、**五个关键设计决策**、**Token 失效矩阵 6 条硬验收**、照片链路安全口径、M8 提交与状态机、反向验证清单、前置核查闸门、风险与限制 |
...
| Phase 5 师傅 H5 | 🟡 **进行中（2026-09-23 启动）** —— 计划见 `docs/PHASE-5.md`；硬验收 = **Token 失效矩阵 6 条**（`401 TOKEN_INVALID`，HTTP 层取证） |
